 ...
 * @author Ratino
 */
public class CreatePdfSRN2 implements BasePdfGenerator{
    ...
    public void generate(PolisModel polisModel, String product, String[] params) throws Exception {
        ...
        canvas.showTextAligned(Element.ALIGN_LEFT,
                "Perihal : Pembayaran", xAddr, 201, 0);
        canvas.setFontAndSize(arialBold, 8f);
        ...
        canvas.showTextAligned(Element.ALIGN_LEFT, "Mohon pembayaran Premi/Kontribusi dilakukan melalui transfer ke rekening atas nama [OWNER] sebagai berikut :", xAddr, 150, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, "• No Rekening VA [YBANKKEY] atau [YBANKKEY]", 73, 140, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, ":", 263, 140, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, "[FLDENT] atau [FLDENT]", 273, 140, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, "• Rekening", 73, 130, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, ":", 263, 130, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, "Rupiah", 273, 130, 0);
        canvas.showTextAligned(Element.ALIGN_LEFT, "Keterangan :", 73, 120, 0);
        canvas.endText();
        ...
        txt.writeParagraph(end, document, xAddr, bottomY, rightX, 100, canvas, arialItalic, 7.5f, 1.2f);
