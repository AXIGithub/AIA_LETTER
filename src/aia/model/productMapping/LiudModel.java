...
public class LiudModel extends BaseModel{
    ...
    public void setPtrneff(String ptrneff) {
        this.ptrneff = ptrneff;
    }

    public String getUsrProfil() {
        return usrProfil;
    }

    public void setUsrProfil(String usrProfil) {
    ...
    public String getdBillfreq() {
        return dBillfreq;
    }

    public void setdBillfreq(String dBillfreq) {
        this.dBillfreq = dBillfreq;
    }
    ...
    public String getFldent() {
        return fldent;
    }

    public void setFldent(String fldent) {
        this.fldent = fldent;
    }

    public String getYbankkey() {
        return ybankkey;
    }

    public void setYbankkey(String ybankkey) {
        this.ybankkey = ybankkey;
    }

    public String getYsustyp() {
        return ysustyp;
    }

    public void setYsustyp(String ysustyp) {
