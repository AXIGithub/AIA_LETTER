...
public class CreatePdfOAD implements BasePdfGenerator{
    ...
    public void generate(PolisModel polisModel, String product, String[] params) throws Exception {
        ...
        canvas.setFontAndSize(arialBold, 9f);
        canvas.showTextAligned(Element.ALIGN_LEFT, "[ALAMAT_BR1]" , xDataInfo2, yInfo2, 0);
        yInfo2 -= 12.5;
        
        canvas.setFontAndSize(arialBold, 9f);
        canvas.showTextAligned(Element.ALIGN_LEFT, "[ALAMAT_BR2]" + " " + "[ALAMAT_BR3]", xDataInfo2, yInfo2, 0);
        yInfo2 -= 12.5;
        
        canvas.setFontAndSize(arialBold, 9f);
        canvas.showTextAligned(Element.ALIGN_LEFT, "[ALAMAT_BR4]" + " " + "[ALAMAT_BR5]", xDataInfo2, yInfo2, 0);
        yInfo2 -= 12.5;
        
        canvas.setFontAndSize(arialBold, 9f);
        canvas.showTextAligned(Element.ALIGN_LEFT, "[CCODE_BR0]", xDataInfo2, yInfo2, 0);
        ...
        txt.writeParagraph(paragraph2, document, xAddr, bottomY, rightX, 380, canvas, arial, 9f, 1.2f);
